...
$string['customwwwroot'] = 'Custom Moodle base URL for course link';
$string['customwwwroot_desc'] = 'This defines the Moodle base URL that is used for the generation of the course link URL in the QR code. In other words, this value becomes the prefix for /course/view.php?id=12345 in the QR code URL. If this setting is empty, the current value of $CFG->wwwroot is used instead. Current value of $CFG->wwwroot: {$a}';
