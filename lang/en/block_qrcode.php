...
$string['customhost_desc'] = 'Define a custom host that will be placed before the course link (e.g., https://host/moodle/course/view.php?id=...). Note that the custom host must cover the entire value of $CFG->wwwroot, or the link wont work otherwise! Your current CFG->wwwroot is: ';
...
$string['use_customhost'] = 'Use a custom host name';
$string['use_customhost_desc'] = 'If enabled, a custom host name can be defined for the QR-code url. Only use this if you have a good reason to do so!';
